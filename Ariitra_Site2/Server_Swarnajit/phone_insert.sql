...
BEGIN
    IF OS1='IOS' THEN
        INSERT INTO IPHONE_CORE_MOBILE1@site_friend VALUES (P_ID, OS1, MODEL1, PROCESSOR1, RAM1, ROM1, CAMERA1, PRICE1, BRAND1);
        INSERT INTO iphone_fency_mobile2 VALUES(P_ID, DISPLAY1, BATTERY1, COLOR1, SIM1);
    ELSIF OS1='android' then
        INSERT INTO android_core_mobile3 VALUES (P_ID, OS1, MODEL1, PROCESSOR1, RAM1, ROM1, CAMERA1, PRICE1, BRAND1);
        INSERT INTO Android_Fency_Mobile4@site_friend VALUES(P_ID, DISPLAY1, BATTERY1, COLOR1, SIM1);
    END IF;
